...
class YouTubeService {
  ...
  Future<List<dynamic>> fetchVideos() async {
    ...
    if (Platform.isAndroid) {
      headers['X-Android-Package'] = packageInfo.packageName;// Must match Console
      headers['X-Android-Cert'] = 'C2CB1D6B45997BE617DBBD16D48F5A3BAC32BFCC';       // No colons
    } else if (Platform.isIOS) {
     headers['X-Ios-Bundle-Identifier'] = packageInfo.packageName; // Must match Console
    }
